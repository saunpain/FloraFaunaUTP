...
public class Vista_Fl {
    ...
    public Vista_Fl(String nombre_estudiante, String fecha_estudiante, String lugar, String titulo, String foto_flora,
            String nombre_cientifico_flora, String nombre_planta, int id_publicacion) {
