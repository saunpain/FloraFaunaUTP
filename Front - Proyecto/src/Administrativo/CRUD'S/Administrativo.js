...
function GuardarAdministrativo() {
    let data = {
        ...
        correo_admin: document.getElementById("input3").value,
    }
...
function ActualizarAdministrativo(id) {
    let data = {
        id_admin:id,
        nombre_admin: document.getElementById('input2').value,
        correo_admin: document.getElementById('input3').value,
...
function ImprimirAdministrativos(admin){
...
function MapearAdministrativos(a){
    return `<tr class="bg-white border-b-[15px] border-[#F0F9FF]" id="${a.id_admin}">
    <td class="py-2 xl:px-8 lg:px-4">
        <img src="${a.perfil_admin}" class="w-14 h-16 rounded-md justify-center mx-auto">
    </td>
    <td class="text-center xl:px-8 lg:px-4 py-2 whitespace-nowrap text-gray-700">${a.id_admin}</td>
    <td class="text-center xl:px-8 lg:px-4 py-2 whitespace-nowrap text-gray-700">${a.nombre_admin}</td>
    <td class="text-center xl:px-8 lg:px-4 py-2 whitespace-nowrap text-gray-700">${a.correo_admin}</td>
    <td class="xl:px-8 lg:px-4">
        <div class="botoncitos flex items-center">
            <button onclick="hacerEditable('${a.id_admin}')">
                <img src="https://github.com/saunpain/FloraFaunaUTP/blob/main/img/pen%201.png?raw=true" class="w-5 max-w-none">
            </button>
            <button onclick= "EliminarAdministrativo('${a.id_admin}')" class="xl:ml-3 lg:ml-2">
...
function hacerEditable(id) {
    ...
    enviar.onclick = function () {
        ...
        ActualizarAdministrativo(id); // Pasa el id como parámetro
    };
